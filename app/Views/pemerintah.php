...
<div class="page-content" itemscope itemtype=" http://schema.org/Blog">
    <div class="container">
        <article class="page-article" itemprop="blogPost">
            ...
            <img width="250" itemprop="image" src="<?= base_url('admin/uploads/' . $_SESSION['logo']) ?>" alt="Image">
            <?= $isi ?>
            <div class="share-section">
                <span>Share Via<a href="https://www.facebook.com/sharer.php?u=<?= base_url('pemerintah') ?>"><i
                            class="fab fa-facebook-f"></i><a
                            href="https://twitter.com/intent/tweet?url=<?= base_url('pemerintah') ?>"><i
